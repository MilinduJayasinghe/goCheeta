            ...
            <table class="table">
                ...
                while ($row = $getDrivers->fetch_assoc()) { ?>
                    ...
                    <tr>
                        ...
                        <td><a href="edit_driver.php?driverId=<?php echo base64_encode($row["driver_id"]); ?>" class="btn btn-info">Edit</a> &nbsp;</td>
                        <td><a href="../controller/driverController.php?type=deleteDriver&driverId=<?php echo base64_encode($row["driver_id"]); ?>" class="btn btn-info">Delete</a> &nbsp;</td>
                    </tr>
